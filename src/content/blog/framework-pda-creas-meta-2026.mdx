...
description: "Le framework PDA (Persona / Désir / Awareness) est la colonne vertébrale d'une production créative qui nourrit Andromeda en signaux distincts. Matrice 27 cases, process batch shooting, cas pratique DNVB compléments alim. Données issues de 86 352 publicités Meta analysées par Gang4."
author: "samuel"
...
cta:
  ...
  contextLabel: "Gang4 génère 20 créas UGC pensées case par case selon ton framework PDA, personnalisées pour ta verticale DNVB"

leadMagnet:
  type: "template"
  eyebrow: "Offert · 20 créas UGC PDA pour ton produit"
  title: "Reçois 20 créas UGC gratuites pensées selon ton framework PDA, personnalisées pour ta marque"
  description: "20 créas UGC conçues case par case selon ta matrice PDA (Persona / Désir / Awareness), personnalisées pour ta verticale et prêtes à uploader dans Meta Ads Manager."
  bullets:
    - "20 créas UGC couvrant au moins 6 cases PDA distinctes"
    - "Personnalisées pour ton produit, tes personas et ta verticale"
    - "Formats pensés pour les signaux qu'Andromeda valorise (hook 0-3s, authenticité, engagement qualitatif)"
    - "Prêtes à uploader directement dans ton Business Manager"
  ctaLabel: "Recevoir mes 20 créas UGC PDA"
...
<KeyTakeaways
  ...
  items={[
    ...
    "Sur 86 352 publicités analysées par Gang4, les <strong>créas qui scalent couvrent au moins 3 dimensions PDA distinctes</strong>."
  ]}
/>
...
<Callout variant="data" title="Ce qu'on observe sur le pool Gang4">
  Sur 86 352 publicités Meta analysées (4 082 campagnes, 32 M€ de spend cumulé), le pattern est systématique : les comptes qui saturent malgré un volume de créas correct concentrent leur spend sur 2 à 4 créas conceptuellement identiques. Andromeda explore le même bassin d'audience en boucle, le sature, et le CPM monte sans augmentation de reach qualifié.
</Callout>

C'est exactement ce que j'ai vécu chez Perifit. On testait 30 créas par mois. Je me souviens d'un audit qu'on a fait en interne : on a posé toutes les créas du trimestre sur une table (au sens littéral, des screenshots imprimés). Résultat : on avait 6 concepts distincts, répétés en 28 exécutions différentes. Andromeda recevait 6 signaux, pas 30. Le CPA stagnait depuis 8 semaines. C'est là que le framework PDA a commencé à prendre forme.
...
Pour construire 3 à 5 archétypes de personas par marque, l'exercice le plus efficace que je connaisse : lis 200 commentaires non sollicités sur les publicités existantes de la marque et de ses concurrents directs. Les personas émergent du langage réel des clients, pas d'une persona marketing fabriquée en salle de réunion.

J'ai fait cette erreur tôt dans ma carrière, sur un compte e-commerce mode. On avait brieffé les créas par tranche d'âge : "femme 25-35", "femme 35-50". On croyait couvrir des personas distincts. En réalité, le signal à l'écran était identique. Même tonalité, même style de produit, même désir sous-jacent. Andromeda voyait un seul concept. On n'a compris le problème qu'en allant lire les commentaires organiques de la marque, où deux profils de clientes très différents s'exprimaient dans un langage radicalement distinct.
...
J'ai passé 3 mois dans cette boucle sur un compte wellness. On avait une créa qui performait. On en a fait 14 variations : hook différent, musique différente, sous-titres d'une autre couleur. Toutes couvraient le même Persona, le même Désir, le même niveau d'Awareness. Le spend se concentrait sur les 2-3 premières. Les 11 autres mouraient à 20€ chacune. On n'avait pas exploré de territoire. On avait juste optimisé le même bout de plage.
...
<StatGrid
  columns={3}
  stats={[
    { value: "9", label: "Cases PDA couvertes (sur 27 possibles)", source: "Sélection verticale compléments alim" },
    { value: "3", label: "Niveaux d'awareness distincts explorés en parallèle", source: "Framework PDA" },
    { value: "1 jour", label: "De shooting pour 25 à 30 créas finalisées (avec briefs préparés)", source: "Process batch shooting Gang4" },
    { value: "86 352", label: "Publicités Meta analysées dans la base Gang4", source: "Gang4 · 4 082 campagnes · 32 M€ spend" },
    { value: "68 300", label: "Créatives uniques indexées (dont 57 613 avec data perf)", source: "Gang4 · base data propriétaire" },
    { value: "2-4", label: "Cases PDA couvertes en moyenne sur les comptes avant audit", source: "Observation pool DNVB Gang4" },
  ]}
/>

<Callout variant="insight" title="Ce qu'on observe sur les comptes qui ont structuré leur production en PDA">
  Sur les comptes du pool Gang4 qui sont passés à une production structurée en cases PDA (9 cases minimum, 3 niveaux d'awareness couverts), le délai entre le lancement d'un nouveau créatif et son identification comme "winner potentiel" par Andromeda (spend qui monte, CPM qui se stabilise) est réduit. La raison : chaque case PDA envoie des signaux suffisamment distincts pour qu'Andromeda ne les traite pas comme des doublons. Il explore réellement, au lieu de saturer le même bassin.
</Callout>
