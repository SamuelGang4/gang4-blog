...
leadMagnet:
  ...
  title: "Reçois 20 créas UGC gratuites prêtes à lancer dès la signature de ton contrat creator"
  description: "Une fois ton contrat creator signé, il te faut du contenu à diffuser vite. 20 créas UGC personnalisées par notre IA, conformes Loi Billon, prêtes à uploader en Partnership Ads."
  bullets:
    - "20 créas UGC personnalisées pour ta verticale DNVB"
    - "Mention de partenariat commercial intégrée (conforme Loi Billon)"
    - "Prêtes à uploader en Partnership Ads dans ton Business Manager"
