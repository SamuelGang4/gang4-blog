...
<KeyTakeaways
  ...
  items={[
    ...
    "Sur <strong>86 352 publicités Meta analysées</strong> par Gang4, les litiges creator les plus fréquents arrivent après 12 mois — quand les droits d'usage ont expiré mais que la pub tourne encore.",
...
Ces erreurs, je les ai vues sur des dizaines de campagnes. Pas d'invention, pas de théorie. Du terrain.

**Erreur 1 : pas de clause de révocation du code de permission.**

Un account manager d'une DNVB mode m'a raconté ça il y a quelques mois. Budget PA en cours : 8 000€/semaine. Le créateur avait un désaccord avec la marque sur le contenu d'une story organique (non lié à la PA). Il a révoqué son code LBC par représailles. Toutes les PA se sont arrêtées à 18h un vendredi soir. 3 jours à reconstruire la campagne avec un autre créateur, en urgence, avec un CPM 40% plus élevé parce que la période de chauffe était perdue.

Un préavis contractuel de 30 jours avec clause d'indemnisation n'aurait pas évité la brouille. Mais il aurait probablement suffi à empêcher la révocation impulsive.
...
"Nous te payons 800€ pour la collaboration." HT ou TTC ? Le créateur est en micro-entreprise sous le seuil de TVA, mais il vient de passer sous un autre statut en janvier ? Tu lui avais envoyé un virement sans facture, et 18 mois plus tard tu reçois une mise en demeure pour travail dissimulé ?
...
<Callout variant="data" title="Ce qu'on observe sur 50+ comptes DNVB Gang4">
  Sur les 86 352 publicités Meta analysées dans notre base (32 M€ de spend, 12 mois), les comptes qui maintiennent leurs PA en rotation longue (6 mois et plus) sans renouveler les accords creator sont systématiquement exposés à des risques contractuels post-campagne. La durée médiane d'une PA performante dans notre pool dépasse 8 mois. La durée médiane d'un contrat creator classique est de 3 à 6 mois. L'écart entre ces deux durées est l'angle mort le plus fréquent.
</Callout>
...
Ces fourchettes sont issues des observations terrain sur le pool Gang4, pas d'une étude formelle. Elles varient selon la verticale, le niveau de notoriété du créateur, et la durée des droits demandés.
...
<DataTable
  ...
  caption="Fourchettes indicatives — pool DNVB FR Gang4 (2025-2026). À titre de benchmark uniquement."
/>
...
J'ai une anecdote là-dessus. Début 2025, on accompagnait une DNVB cosmétique sur un programme de 8 créateurs simultanés. Un seul contrat n'avait pas de clause d'exclusivité rédigée correctement. Le créateur a collaboré avec une marque directement concurrente trois semaines après le lancement de notre campagne. La PA continuait de tourner. Lui aussi. Le conflit de marque dans le fil d'actualité d'une même audience a brouillé le signal Andromeda pendant 6 semaines. On a perdu du temps à diagnostiquer avant de trouver la cause. Depuis, l'exclusivité est le premier point qu'on vérifie dans chaque contrat avant signature.
...
<SequenceFlow
  ...
  caption="Ces 5 points à vérifier avant signature évitent 80% des litiges post-campagne observés sur le pool Gang4."
/>
...
Un template de contrat, même bien fait, ne remplace pas une vraie relation opérationnelle avec tes créateurs. Les meilleurs programmes PA que j'ai vus fonctionnent parce que les créateurs comprennent ce qu'on cherche à faire, pas seulement parce qu'ils ont signé un document.
...
Sur 50+ DNVB clientes accompagnées chez Gang4, ce qu'on voit le plus souvent comme frein à la performance PA n'est pas contractuel. C'est la pénurie de contenu. Un programme PA qui tourne bien a besoin de 8 à 15 créatifs nouveaux par mois. Peu de DNVB ont la bande passante pour produire ça avec des créateurs humains uniquement.
...
<Callout variant="data" title="Sur 86 352 publicités Meta analysées par Gang4">
  Les comptes DNVB qui maintiennent un flux continu de Partnership Ads dans une structure ASC broad, avec renouvellement créatif régulier et pool diversifié de 5 créateurs minimum, ont un profil de performance qualitativement différent des comptes qui lancent des PA de façon ponctuelle. Le contrat est une condition nécessaire. Ce n'est pas une condition suffisante.
</Callout>
